    ...
    public class LineCatDbInitializer : SqliteDropCreateDatabaseAlways<LineCatDb>
    {
        ...
        protected override void Seed(LineCatDb context)
        {
            ...
            var Products = new List<Product>
            {
                ...
                new Product() {ID="B00HYOGRZC",MallRuleID="1",Title="象印 sd-ea08 黑红", Url="http://www.amazon.co.jp/gp/product/B00HYOGRZC", Timer=0,CreateDate=DateTime.Now, SortNum=0,Disable=0, RecommendAlertPrice=1600},
                ...
                new Product() {ID="B00IDYAF6O",MallRuleID="1",Title="膳魔师 ffz-800f 黑黄", Url="http://www.amazon.co.jp/gp/product/B00IDYAF6O", Timer=0,CreateDate=DateTime.Now, SortNum=0,Disable=0, RecommendAlertPrice=1600},
                ...
                new Product() {ID="B00IDYAF7I",MallRuleID="1",Title="膳魔师 ffz-800f 黑红", Url="http://www.amazon.co.jp/dp/B00IDYAF7I", Timer=0,CreateDate=DateTime.Now, SortNum=0,Disable=0, RecommendAlertPrice=1600},
                ...
                new Product() {ID="B00BB76L90",MallRuleID="1",Title="膳魔师 jda400", Url="http://www.amazon.co.jp/dp/B00BB76L90", Timer=0,CreateDate=DateTime.Now, SortNum=0,Disable=0, RecommendAlertPrice=1400},
